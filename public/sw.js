...
self.addEventListener('push', (event) => {
  ...
  const options = {
    body: event.data ? event.data.text() : 'New notification from Vibe POS',
  ...
  event.waitUntil(
    self.registration.showNotification('Vibe POS', options)
  );
});
