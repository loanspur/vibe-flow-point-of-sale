...
import { Users, UserPlus, Link, Edit, Trash2, Phone, Mail, MapPin, Plus, UserCheck } from 'lucide-react';
...
const SalesRepManagement = () => {
  ...
  const salesReps = contacts.filter(contact => contact.type === 'sales_rep');
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Contact & Sales Rep Management</h1>
          <p className="text-muted-foreground">Manage contacts and sales representatives with profile mapping</p>
        </div>
      </div>
