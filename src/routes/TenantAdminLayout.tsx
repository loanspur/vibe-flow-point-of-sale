...
export function TenantAdminLayout() {
  ...
  // Sentinel: detect if TenantAdminLayout is mounted on /auth (should never happen)
  useEffect(() => {
    if (window.location.pathname.startsWith('/auth')) {
      console.warn('[sentinel] TenantAdminLayout mounted on /auth — this should never happen');
    }
  }, []);
