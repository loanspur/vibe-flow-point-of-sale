-- AI Database Schema Migration (Fixed Version)
...
BEGIN
    ...
    SELECT 
        ds.forecast_date,
        1000.00 * (1 + (random() * 0.2 - 0.1)) AS forecast_value,
        800.00 AS confidence_lower,
        1200.00 AS confidence_upper,
...
BEGIN
    ...
    SELECT 
        ds.forecast_date,
        50.00 * (1 + (random() * 0.3 - 0.15)) AS forecast_value,
        35.00 AS confidence_lower,
        65.00 AS confidence_upper,
