-- Create tenant and link user profile for the logged in user (fixed)
DO $$
DECLARE
...
BEGIN
    ...
    -- Temporarily disable the trigger to avoid updated_at column issue
    ...
    -- Manually create tenant_users entry
