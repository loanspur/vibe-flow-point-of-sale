...
CREATE TYPE IF NOT EXISTS feature_type AS ENUM ('core', 'premium', 'enterprise', 'addon');
CREATE TYPE IF NOT EXISTS feature_status AS ENUM ('active', 'inactive', 'deprecated', 'beta');
...
ADD COLUMN IF NOT EXISTS feature_set_id UUID,
