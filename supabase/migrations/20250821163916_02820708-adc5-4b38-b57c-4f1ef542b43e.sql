-- Create enhanced role management tables

-- Create system_permissions table with text fields (avoiding enum conflicts)
...
-- Insert basic system permissions using text values
