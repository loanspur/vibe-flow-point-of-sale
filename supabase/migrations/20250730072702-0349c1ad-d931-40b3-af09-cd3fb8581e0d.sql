-- First, let's see what transaction types are allowed and add the new ones
-- Remove the old constraint and add a new one with drawer transfer types
ALTER TABLE public.cash_transactions 
DROP CONSTRAINT IF EXISTS cash_transactions_transaction_type_check;

-- Add new constraint with drawer transfer types
ALTER TABLE public.cash_transactions 
